...
- `initialised`: it's activated once either when the Builder is KYC approved for the first time (`BuilderRegistry#initialiseBuilder()`). This flag will never be unset.
