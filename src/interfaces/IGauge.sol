...
interface IGauge {
    ...
    /// @notice View to see the totalSupply given the timestamp of the start of the epoch
    function totalSupplyByEpoch(uint256) external view returns (uint256);
    ...
    /// @notice Withdraw LP tokens for user
    /// @param _amount .
    /// @param _recipient Recipient to retreive balance to
