...
import { ICollectiveRewardsCheckRootstockCollective } from "../interfaces/ICollectiveRewardsCheckRootstockCollective.sol"; //def not
...
contract BuilderRegistryRootstockCollective is CycleTimeKeeperRootstockCollective, ERC165Upgradeable {
  ...
  function supportsInterface(bytes4 interfaceId_) public view override returns (bool) {
    return
      interfaceId_ == type(ICollectiveRewardsCheckRootstockCollective).interfaceId || // change to some other interface presumably
