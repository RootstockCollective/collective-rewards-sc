...
import { BaseTest, SponsorsManager, BuilderGauge } from "./BaseTest.sol";
...
contract SponsorsManagerTest is BaseTest {
    ...
    function test_RevertGaugeExists() public {
        ...
        vm.expectRevert(SponsorsManager.BuilderGaugeExists.selector);
     ...
     */
    function test_CreateBuilderGauge() public {
        ...
        emit BuilderGaugeCreated(_newBuilder, /*ignored*/ address(0), address(this));
    ...
    function test_RevertAllocateBatchUnequalLengths() public {
        ...
        sponsorsManager.allocateBatch(builderGaugesArray, allocationsArray);
    }
    ...
    function test_RevertNotInDistributionPeriod() public {
        ...
        for (uint256 i = 0; i < 20; i++) {
            BuilderGauge _newBuilderGauge = sponsorsManager.createBuilderGauge(makeAddr(string(abi.encode(i + 10))));
            builderGaugesArray.push(_newBuilderGauge);
    ...
    function test_DistributeUsingPagination() public {
        ...
        assertEq(sponsorsManager.lastDistributedBuilderGaugeIndex(), 20);
        ...
        assertEq(sponsorsManager.lastDistributedBuilderGaugeIndex(), 0);
    ...
    function test_ClaimSponsorRewards() public {
        ...
        vm.prank(alice);
        sponsorsManager.claimSponsorRewards(builderGaugesArray);
