...
contract SkipDistribution is BaseTest {
    ...
    function test_integration_NoDistributionOnCycle() public {
        ...
        // THEN gauge2 builder receives rifToken
        // cycle 1 = 0
        // cycle 2 = 50 * 1 / 4 = 12.5
        // cycle 3 = 0 (no new distribution)
        // cycle 4 = 50 * 2 / 5 = 20
    ...
    function test_integration_PaginatedDistributionNotFinishedOnCycle() public {
        ...
        // CYCLE 2
        // AND distribution of 100 rifToken and 10 native tokens starts
        ...
        vm.prank(alice);
        backersManager.claimBackerRewards(gaugesArray);
        // THEN alice receives more rifToken than she should
        // cycle 1 = 0
        // cycle 2 = 50 * 2 / 4 = 25
        ...
        vm.prank(bob);
        backersManager.claimBackerRewards(gaugesArray);
        // THEN bob receives more rifToken than he should
        // cycle 1 = 0
        // cycle 2 = 50 * 2 / 4 = 25
        ...
        // THEN gauge builder has earned rifToken
        // cycle 1 = 0
        // cycle 2 = 50 * 3 / 4 = 37.5
        // cycle 3 = 0 (no new distribution)
        // cycle 4 = 50 * 3 / 4 = 37.5
        ...
        // THEN gauge2 builder has earned rifToken
        // cycle 1 = 0
        // cycle 2 = 50 * 1 / 4 = 12.5
        // cycle 3 = 0 (no new distribution)
        // cycle 4 = 50 * 1 / 4 = 12.5
