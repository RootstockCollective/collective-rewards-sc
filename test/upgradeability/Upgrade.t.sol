...
import { BuilderRegistryRootstockCollectiveUpgradeMock, RewardDistributorRootstockCollectiveUpgradeMock, GaugeUpgradeMock, GovernanceManagerRootstockCollectiveUpgradeMock } from "../mock/UpgradesMocks.sol";
...
contract UpgradeTest is BaseTest {
    ...
    function test_UpgradeBuilderRegistryRootstockCollective() public {
        ...
        BuilderRegistryRootstockCollectiveUpgradeMock _builderRegistryNewImpl = new BuilderRegistryRootstockCollectiveUpgradeMock();
        //WHEN the proxy is upgraded and initialized
        vm.prank(governor);
        builderRegistry.upgradeToAndCall(
            address(_builderRegistryNewImpl),
            abi.encodeCall(_builderRegistryNewImpl.initializeMock, (42))
        );
    ...
    function test_UpgradeRewardDistributorRootstockCollective() public {
        ...
        // AND a new implementation
        RewardDistributorRootstockCollectiveUpgradeMock _rewardDistributorNewImpl = new RewardDistributorRootstockCollectiveUpgradeMock();
        //WHEN the proxy is upgraded and initialized
        vm.prank(governor);
        rewardDistributor.upgradeToAndCall(
            address(_rewardDistributorNewImpl),
            abi.encodeCall(_rewardDistributorNewImpl.initializeMock, (43))
        );
        uint256 _newVar = RewardDistributorRootstockCollectiveUpgradeMock(payable(rewardDistributor))
            .getCustomMockValue() - (uint256(uint160(foundation)));
    ...
    function test_UpgradeGovernanceManagerRootstockCollective() public {
        ...
        // AND a new implementation
        GovernanceManagerRootstockCollectiveUpgradeMock _governanceManagerNewImpl = new GovernanceManagerRootstockCollectiveUpgradeMock();
        //WHEN the proxy is upgraded and initialized
        vm.prank(governor);
        governanceManager.upgradeToAndCall(
            address(_governanceManagerNewImpl),
            abi.encodeCall(_governanceManagerNewImpl.initializeMock, (45))
        );
        uint256 _newVar = GovernanceManagerRootstockCollectiveUpgradeMock(address(governanceManager))
    ...
    function test_UpgradeGauge() public {
        ...
        uint256 _newVar = GaugeUpgradeMock(address(gauge)).getCustomMockValue() -
            (uint256(uint160(address(backersManager))));
        ...
        uint256 _newVar2 = GaugeUpgradeMock(address(gauge2)).getCustomMockValue() -
            (uint256(uint160(address(backersManager))));
        ...
        uint256 _newVar3 = GaugeUpgradeMock(_newGauge).getCustomMockValue() -
            (uint256(uint160(address(backersManager))));
